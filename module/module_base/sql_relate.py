from module.module_class.database_class import DataBase
from module.module_base.config import main_config
from module.module_base.logger import logger

database = DataBase(main_config.database_config.database_name, main_config.database_config.host,
                    main_config.database_config.username, main_config.database_config.password, main_config.database_config.port)
database.connect()
connected = database.get_connection_info()
